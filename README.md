...
Phenopackets JSON documents can be converted from [V1](https://phenopacket-schema.readthedocs.io/en/1.0.0/toplevel.html) to [V2](https://phenopacket-schema.readthedocs.io/en/2.0.0/toplevel.html) using bentoctl and [Phenopacket-tools](https://github.com/phenopackets/phenopacket-tools) as its backend.
...
If the `target` argument is not provided, bentoctl will append "_pheno_v2" to the source file's name and save it in its parent directory.
